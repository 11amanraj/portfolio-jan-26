...
const page = () => {
    return (
        <>
            <div>
                <div className='relative bg-red-500 w-screen h-[60vh] md:h-[75vh] object-cover overflow-hidden'>
                    <img src="\project-thumbnails\elderly-ux.jpg" alt="elderly-mobile-usage-thumbnail" />
                </div>

                <div className="max-w-304 mx-4 md:mx-8 xl:mx-auto">
                    <TitleSection />
